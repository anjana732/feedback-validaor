...
//     console.log("message value", value, typeof(value));
//     if(typeof(value) === "string"){
//       console.log("came to set setMessage");
//       setMessage(value);
...
//    navigate('/feedback',{ state:{message}})
// }, [message]);
...
function FeedbackFormContent() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (typeof message === "string" && message.trim().length > 0) {
      console.log("Navigating with message:", message);
      navigate("/feedback", { state: { message } });
    } else {
  ...
  return (
    <div className="w-full px-6 lg:px-16 py-12">
      <div className="flex flex-col lg:flex-row justify-between items-start gap-12">
        ...
        <div className="w-full lg:max-w-xl">
          <form
            className="space-y-6 bg-white dark:bg-zinc-900 p-6 rounded-2xl shadow-xl h-full"
            ref={formRef}
